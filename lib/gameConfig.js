...
export const LEVELS = [
  { name: "Beginner", deg1: 1, deg2: 1, emoji: "🌱", time: 120, desc: "ดีกรี 1 × 1" },
  { name: "Easy",     deg1: 2, deg2: 1, emoji: "🧩", time: 150, desc: "ดีกรี 2 × 1" },
  { name: "Medium",   deg1: 2, deg2: 2, emoji: "⚡", time: 180, desc: "ดีกรี 2 × 2" },
  { name: "Hard",     deg1: 3, deg2: 2, emoji: "🔥", time: 210, desc: "ดีกรี 3 × 2" },
